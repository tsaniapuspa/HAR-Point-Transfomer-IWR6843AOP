...
DEMO_TWO_PASS_VIDEO_DOORBELL = "2-Pass Video Doorbell"
...
BUSINESS_DEMOS = {
    "Industrial": [
        ...
        DEMO_GESTURE, DEMO_SURFACE, DEMO_LEVEL_SENSING, DEMO_GROUND_SPEED, DEMO_CALIBRATION, DEMO_EBIKES, DEMO_REPLAY, DEMO_VIDEO_DOORBELL, DEMO_TWO_PASS_VIDEO_DOORBELL
    ],
    "BAC": [
        DEMO_OOB_x843, DEMO_OOB_x432, DEMO_3D_PEOPLE_TRACKING, DEMO_GESTURE, DEMO_KTO, DEMO_CALIBRATION, DEMO_DASHCAM, DEMO_REPLAY
    ]
}
...
DEVICE_DEMO_DICT = {
    "xWR6843": {
        ...
        "isxWRLx432": False,
        "singleCOM": False,
        "demos": [DEMO_OOB_x843, DEMO_3D_PEOPLE_TRACKING, DEMO_SMALL_OBSTACLE, DEMO_GESTURE, DEMO_SURFACE, DEMO_LONG_RANGE, DEMO_MOBILE_TRACKER, DEMO_VITALS, DEMO_GROUND_SPEED]
    },
    "xWR1843": {
        "isxWRx843": True,
        "isxWRLx432": False,
    ...
    "xWRL6432": {
        ...
        "isxWRLx432": True,
        "singleCOM": True,
        "demos": [DEMO_OOB_x432, DEMO_LEVEL_SENSING, DEMO_GESTURE, DEMO_SURFACE, DEMO_GROUND_SPEED, DEMO_SMALL_OBSTACLE, DEMO_KTO, DEMO_VITALS, DEMO_DASHCAM, DEMO_REPLAY, DEMO_EBIKES, DEMO_VIDEO_DOORBELL, DEMO_TWO_PASS_VIDEO_DOORBELL, DEMO_CALIBRATION]
    },
    "xWRL1432": {
        "isxWRx843": False,
        "isxWRLx432": True,
        "singleCOM": True,
        "demos": [DEMO_OOB_x432, DEMO_LEVEL_SENSING, DEMO_GESTURE, DEMO_GROUND_SPEED, DEMO_KTO, DEMO_CALIBRATION, DEMO_DASHCAM, DEMO_EBIKES, DEMO_REPLAY]
    }
}
